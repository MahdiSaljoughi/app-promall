...
export default function page() {
  return (
    <div className="flex flex-col h-screen bg-product-gradient">
      ...
      <div className="w-full flex justify-center items-center relative min-h-[500px]">
        ...
        <div className="inline-flex absolute bottom-5 gap-1">
          <div className="w-1 bg-white h-1 rounded-3xl"></div>
          <div className="w-1 bg-white h-1 rounded-3xl"></div>
          <div className="w-5 bg-white h-1 rounded-3xl"></div>
          <div className="w-1 bg-white h-1 rounded-3xl"></div>
        </div>
      </div>

      {/* Product Info Section */}
      <div className="bg-black/40 w-full flex-grow rounded-t-3xl drop-shadow-2xl shadow-2xl flex flex-col justify-between">
        {/* Product Title */}
        <div className="flex flex-col items-center mt-8 mx-5">
        ...
        <div className="flex flex-col mx-6 gap-1">
          <div className="inline-flex items-center justify-between mb-2">
            ...
            <div className="inline-flex justify-center items-center ml-2">
              <span className="text-[16px] text-white justify-center items-center mt-1 ">
                ۴.۹
              </span>
              &nbsp;&nbsp;
          ...
          <p className="text-default-500">
            کفش نایک دیور خاص لیمیتد، ترکیبی است از طراحی مدرن و ظرافت بی‌نظیر.
            این کفش نه تنها یک کالای ورزشی است، بلکه به عنوان یک اکسسوری لوکس
            نیز شناخته می‌شود.
          </p>
          <div className="inline-flex justify-center items-center mt-8 gap-3">
            <div className="flex flex-col items-center">
              <div className="bg-gray-900 w-9 h-9 rounded-lg"></div>
              <p className="text-center mt-2 ">میدنایت</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-[#DDD7D3] w-9 h-9 rounded-lg"></div>
        ...
        <div className="p-4 flex flex-row gap-2">
          ...
          <div className="flex flex-col justify-center mx-6 items-start basis-1/12 font-bold">
            <span className="text-[12px] text-default-500">موجود در انبار</span>
