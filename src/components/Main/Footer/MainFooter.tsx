...
export default function MainFooter() {
  ...
  return (
    <>
      <footer dir="ltr" className="pt-28 md:pt-36">
        <div className="container mx-auto fixed inset-x-0 bottom-0 bg-sky-100/50 dark:bg-black/50 backdrop-blur-md rounded-t-[32px] px-4 py-6 md:p-6 z-40">
